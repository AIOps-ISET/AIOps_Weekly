...
## 1.2 撰写申请书研究意义部分、完善论文、阅读论文——李亚晓

本周李亚晓同学在上周的积累上撰写了申请书研究意义部分内容，通过分析现状，学习研究意义写法，对研究意义部分有更深的了解；其次根据批注对论文结构和图进行改进；最后阅读了一篇微服务故障检测领域论文，并对代码进行学习，了解了代码具体功能作用。

[阅读笔记-李亚晓](阅读笔记-李亚晓.pdf)
