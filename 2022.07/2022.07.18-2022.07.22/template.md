...
## 1.2 学习实践Kubernetes框架，阅读凤凰架构——惠明轩

本周惠明轩同学在上周学习的基础上部署了kubernetes框架和组件，并且阅读了凤凰架构部分内容。

[惠明轩+部署实践kubernetes和凤凰架构的学习](惠明轩+部署实践kubernetes和凤凰架构的学习.docx)

## 1.3 推进资源类论文撰写，学习故障注入过程——郭帅东

本周郭帅东同学继续完善推进论文撰写，目前内容上已形成初稿，另外本周开始对毕设第一环故障注入部分开始深入学习，从故障注入工具CHaosBlade入手，学习源码，理解注入过程，为后面对故障注入建模打基础。

[郭帅东+ChaosBlade学习笔记](郭帅东+ChaosBlade学习笔记.docx)
