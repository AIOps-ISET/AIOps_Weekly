...
## 1.2 梳理DGM资料+撰写综述论文研究问题部分——李科燃

本周李科燃同学在上周调研的DGM资料基础之上进行了梳理，完成了第493期学术论坛的汇报工作。并撰写了一部分AIOps综述论文的研究问题部分。
...
本周李科燃同学对电信项目中指标异常检测的算法进行了实验和测试，并成功向甲方单位进行了展示。
